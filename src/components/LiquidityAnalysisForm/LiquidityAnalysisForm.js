    ...
    return(
      ...
      <ContainerAnalis>
        <li>
          ...
          {(currentRatio<2.5&&currentRatio>1.5)&&<Text> 1. <Span $Good>Current Ratio більше 1,5  та меньше 2,5.</Span> Це свідчить, що підприємство має достатньо ліквідності для покриття зобов'язань і при цьому не тримає надлишкові активи, які могли б бути краще використані.</Text>}
        </li>
